...
public interface BlobStorageProvider {
  ...
  void upload(
      String containerName, String blobKey, InputStream inputStream, long size, String contentType);

  // Open a streaming read for server-side processing flows (e.g. import parsing).
  InputStream openInputStream(String containerName, String blobKey);
